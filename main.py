...
def main():
    ...
    # Model jest już zapisany przez Checkpoint jako 'best_model_beyond_research.keras'
    print("Najlepszy model zapisano jako: best_model_beyond_research.keras")


    # 4. TESTOWANIE MODELU
    # Załadowanie modelu
    model_path = 'best_model_beyond_research.keras'
    print("[INFO] Wczytanie modelu: {model_path}")
    try:
        model = load_model(model_path)
    except:
        print("BŁĄD: Nie znaleziono modelu 'best_model_beyond_research.keras'. Uruchom najpierw train_model.py!")
        return
